...
namespace Proxies\__CG__\SPruebas\PRUEBASBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Animales extends \SPruebas\PRUEBASBundle\Entity\Animales implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'SPruebas\\PRUEBASBundle\\Entity\\Animales' . "\0" . 'id', '' . "\0" . 'SPruebas\\PRUEBASBundle\\Entity\\Animales' . "\0" . 'nombre', '' . "\0" . 'SPruebas\\PRUEBASBundle\\Entity\\Animales' . "\0" . 'tipo', '' . "\0" . 'SPruebas\\PRUEBASBundle\\Entity\\Animales' . "\0" . 'raza', '' . "\0" . 'SPruebas\\PRUEBASBundle\\Entity\\Animales' . "\0" . 'sexo', '' . "\0" . 'SPruebas\\PRUEBASBundle\\Entity\\Animales' . "\0" . 'nacimiento', '' . "\0" . 'SPruebas\\PRUEBASBundle\\Entity\\Animales' . "\0" . 'propietario', '' . "\0" . 'SPruebas\\PRUEBASBundle\\Entity\\Animales' . "\0" . 'pedigri'];
        }
