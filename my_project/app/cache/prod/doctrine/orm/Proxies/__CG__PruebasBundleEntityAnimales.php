...
namespace Proxies\__CG__\PruebasBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Animales extends \PruebasBundle\Entity\Animales implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'PruebasBundle\\Entity\\Animales' . "\0" . 'id', '' . "\0" . 'PruebasBundle\\Entity\\Animales' . "\0" . 'nombre', '' . "\0" . 'PruebasBundle\\Entity\\Animales' . "\0" . 'tipo', '' . "\0" . 'PruebasBundle\\Entity\\Animales' . "\0" . 'raza', '' . "\0" . 'PruebasBundle\\Entity\\Animales' . "\0" . 'sexo', '' . "\0" . 'PruebasBundle\\Entity\\Animales' . "\0" . 'nacimiento', '' . "\0" . 'PruebasBundle\\Entity\\Animales' . "\0" . 'propietario', '' . "\0" . 'PruebasBundle\\Entity\\Animales' . "\0" . 'pedigri'];
        }
