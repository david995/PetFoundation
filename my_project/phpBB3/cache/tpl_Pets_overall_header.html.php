...
<div id="page-header" class="container-block">
    ...
    <div id="nav-header" class="responsive-menu-nojs">
		<div class="responsive-menu" style="display:none;">
			<?php if ($this->_rootref['L_MENU']) {  ?><a href="javascript:void(0);"><span></span><?php echo ((isset($this->_rootref['L_MENU'])) ? $this->_rootref['L_MENU'] : ((isset($user->lang['MENU'])) ? $user->lang['MENU'] : '{ MENU }')); ?></a><?php } else { ?><a href="javascript:void(0);" class="arrow"><span></span>&darr;&darr;&darr;</a><?php } ?>
