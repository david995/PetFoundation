...
namespace Proxies\__CG__\AnunciosBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Anuncios extends \AnunciosBundle\Entity\Anuncios implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'animal', 'user', '' . "\0" . 'AnunciosBundle\\Entity\\Anuncios' . "\0" . 'id', '' . "\0" . 'AnunciosBundle\\Entity\\Anuncios' . "\0" . 'titulo', '' . "\0" . 'AnunciosBundle\\Entity\\Anuncios' . "\0" . 'categoria'];
        }
